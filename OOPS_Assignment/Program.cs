...
namespace OOPS_Assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            p.printData("Jenil", "Malkan", "Godhra");
            p.printData("9265994242", "jenilmalkan6@gmail.com");
            ...
            teachers.firstName = "Jenil";
            teachers.lastName = "Malkan";

            //To use private data member we have to implement get and set methods
            teachers.Email = "jenilmalkan6@gmail.com";
